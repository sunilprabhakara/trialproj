...
package trialproj.myfirstjob_0_1;
...
/**
 * Job: MyFirstJob Purpose: <br>
 * Description:  <br>
 * @author Prabhakara, Sunil
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class MyFirstJob implements TalendJob {
	static {System.setProperty("TalendJob.log", "MyFirstJob.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(MyFirstJob.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MyFirstJob";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MyFirstJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TRIALPROJ_MyFirstJob = new byte[0];
    static byte[] commonByteArray_TRIALPROJ_MyFirstJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TRIALPROJ_MyFirstJob.length) {
				if(length < 1024 && commonByteArray_TRIALPROJ_MyFirstJob.length == 0) {
   					commonByteArray_TRIALPROJ_MyFirstJob = new byte[1024];
				} else {
   					commonByteArray_TRIALPROJ_MyFirstJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TRIALPROJ_MyFirstJob, 0, length);
			strReturn = new String(commonByteArray_TRIALPROJ_MyFirstJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TRIALPROJ_MyFirstJob) {
...
class tRowGenerator_1Randomizer {
	...
	public String getRandomnewColumn1() {
	...
	for (int itRowGenerator_1=0; itRowGenerator_1<nb_max_row_tRowGenerator_1 ;itRowGenerator_1++) {
		...
		row1.newColumn1 = randtRowGenerator_1.getRandomnewColumn1();
 ...
 */
    ...
    public static void main(String[] args){
        final MyFirstJob MyFirstJobClass = new MyFirstJob();

        int exitCode = MyFirstJobClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'MyFirstJob' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'MyFirstJob' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = MyFirstJob.class.getClassLoader().getResourceAsStream("trialproj/myfirstjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MyFirstJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MyFirstJob");
        }
...
/************************************************************************************************
 *     38767 characters generated by Talend Cloud Data Management Platform 
 *     on the 26 March, 2019 8:58:00 PM IST
 ************************************************************************************************/