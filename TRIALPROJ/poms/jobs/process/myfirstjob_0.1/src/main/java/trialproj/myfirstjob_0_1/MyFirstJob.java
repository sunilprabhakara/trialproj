...
public class MyFirstJob implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "MyFirstJob.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(MyFirstJob.class);
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MyFirstJob.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.prinltn(" Here I Come ....");
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRIALPROJ_MyFirstJob.length) {
					if (length < 1024
							&& commonByteArray_TRIALPROJ_MyFirstJob.length == 0) {
				...
				strReturn = new String(commonByteArray_TRIALPROJ_MyFirstJob, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MyFirstJob.class.getClassLoader()
					.getResourceAsStream(
							"trialproj/myfirstjob_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = MyFirstJob.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MyFirstJob");
		}
...
/************************************************************************************************
 * 40283 characters generated by Talend Cloud Data Management Platform on the 26
 * March, 2019 6:58:03 PM IST
 ************************************************************************************************/
