...
public class MyThirdJob implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "MyThirdJob.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(MyThirdJob.class);
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MyThirdJob.this, new Object[] { e,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRIALPROJ_MyThirdJob.length) {
					if (length < 1024
							&& commonByteArray_TRIALPROJ_MyThirdJob.length == 0) {
				...
				strReturn = new String(commonByteArray_TRIALPROJ_MyThirdJob, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					row1.Message = "This is something else!!!...";
					...
					if (row1.Message != null) { //
						row_tLogRow_1[0] = String.valueOf(row1.Message);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MyThirdJob.class.getClassLoader()
					.getResourceAsStream(
							"trialproj/mythirdjob_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = MyThirdJob.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MyThirdJob");
		}
...
/************************************************************************************************
 * 37428 characters generated by Talend Cloud Data Management Platform on the 27
 * March, 2019 10:30:14 AM IST
 ************************************************************************************************/
