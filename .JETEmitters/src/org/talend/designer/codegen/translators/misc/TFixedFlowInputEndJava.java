...
public class TFixedFlowInputEndJava
{
  ...
  protected final String TEXT_7 = NL + "\tcacheList_";
  protected final String TEXT_8 = ".clear();";
  protected final String TEXT_9 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_10 = "_NB_LINE\", nb_line_";
  protected final String TEXT_11 = ");";
  protected final String TEXT_12 = NL + "\t\t}" + NL + "\t  fid_";
  protected final String TEXT_13 = ".close();" + NL + "\t}" + NL + "" + NL + "\tglobalMap.put(\"";
