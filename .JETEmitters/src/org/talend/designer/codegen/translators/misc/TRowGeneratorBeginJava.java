...
public class TRowGeneratorBeginJava
{
  ...
  protected final String TEXT_28 = "Randomizer();" + NL + "\t";
  protected final String TEXT_29 = NL + "    \tlog.info(\"";
  protected final String TEXT_30 = " - Generating records.\");";
  protected final String TEXT_31 = NL + "\tfor (int i";
  protected final String TEXT_32 = "=0; i";
  protected final String TEXT_33 = "<nb_max_row_";
  protected final String TEXT_34 = " ;i";
  protected final String TEXT_35 = "++) {";
  protected final String TEXT_36 = NL + "\t\t";
  protected final String TEXT_37 = ".";
  protected final String TEXT_38 = " = rand";
  protected final String TEXT_39 = ".getRandom";
  protected final String TEXT_40 = "();";
  protected final String TEXT_41 = NL + "\t\tnb_line_";
  protected final String TEXT_42 = "++;" + NL + "\t\t";
  protected final String TEXT_43 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_44 = " - Retrieving the record \" + nb_line_";
